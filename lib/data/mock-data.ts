...
export const DEFAULT_CATEGORIES: MockCategory[] = [
  {
    ...
    imageUrl: "https://pub-db4e48567ea54fc7b07ee1ddbc1f01eb.r2.dev/categories/maquiagem.png",
    sortOrder: 1,
  ...
  },
  {
    ...
    imageUrl: "https://pub-db4e48567ea54fc7b07ee1ddbc1f01eb.r2.dev/categories/pinceis.png",
    sortOrder: 2,
    createdAt: new Date("2026-01-01"),
  },
  {
    ...
    imageUrl: "https://pub-db4e48567ea54fc7b07ee1ddbc1f01eb.r2.dev/categories/skincare.png",
    sortOrder: 3,
    createdAt: new Date("2026-01-01"),
  },
  {
    ...
    imageUrl: "https://pub-db4e48567ea54fc7b07ee1ddbc1f01eb.r2.dev/categories/perfumaria.png",
    sortOrder: 4,
    createdAt: new Date("2026-01-01"),
  },
  {
    ...
    imageUrl: "https://pub-db4e48567ea54fc7b07ee1ddbc1f01eb.r2.dev/categories/cabelo.png",
    sortOrder: 5,
    createdAt: new Date("2026-01-01"),
  },
  {
    ...
    imageUrl: "https://pub-db4e48567ea54fc7b07ee1ddbc1f01eb.r2.dev/categories/unhas.png",
    sortOrder: 6,
    createdAt: new Date("2026-01-01"),
  },
]
...
export const DEFAULT_BANNERS: MockBanner[] = [
  {
    ...
    imageUrl: "https://pub-db4e48567ea54fc7b07ee1ddbc1f01eb.r2.dev/banners/banner-1-make.webp",
    linkUrl: "/produtos",
    sortOrder: 1,
    isActive: true,
    createdAt: new Date("2026-01-01"),
  },
  {
    ...
    imageUrl: "https://pub-db4e48567ea54fc7b07ee1ddbc1f01eb.r2.dev/banners/banner-2-make.webp",
    linkUrl: "/produtos",
    sortOrder: 2,
    isActive: true,
    createdAt: new Date("2026-01-01"),
...
export const DEFAULT_PRODUCTS: MockProduct[] = [
  {
    ...
    images: ["https://pub-db4e48567ea54fc7b07ee1ddbc1f01eb.r2.dev/products/kit-pinceis.png"],
    stock: 120,
    minQuantity: 3,
    isActive: true,
    isFeatured: true,
  ...
  },
  {
    ...
    images: ["https://pub-db4e48567ea54fc7b07ee1ddbc1f01eb.r2.dev/products/esponja-blender.png"],
    stock: 500,
    minQuantity: 24,
    isActive: true,
    isFeatured: true,
  ...
  },
  {
    ...
    images: ["https://pub-db4e48567ea54fc7b07ee1ddbc1f01eb.r2.dev/products/serum-vitamina-c.png"],
    stock: 80,
    minQuantity: 6,
    isActive: true,
    isFeatured: true,
  ...
  },
  {
    ...
    images: ["https://pub-db4e48567ea54fc7b07ee1ddbc1f01eb.r2.dev/products/protetor-solar.png"],
    stock: 150,
    minQuantity: 12,
    isActive: true,
    isFeatured: true,
  ...
  },
  {
    ...
    images: ["https://pub-db4e48567ea54fc7b07ee1ddbc1f01eb.r2.dev/products/perfume-floral.png"],
    stock: 60,
    minQuantity: 3,
    isActive: true,
    isFeatured: true,
  ...
  },
  {
    ...
    images: ["https://pub-db4e48567ea54fc7b07ee1ddbc1f01eb.r2.dev/products/oleo-capilar.png"],
    stock: 90,
    minQuantity: 6,
    isActive: true,
    isFeatured: true,
  ...
  },
  {
    ...
    slug: "kit-de-maquiagem-40-itens-para-revender",
    ...
    images: ["https://pub-db4e48567ea54fc7b07ee1ddbc1f01eb.r2.dev/products/kit-independencia-financeira.webp"],
    stock: 45,
    minQuantity: 1,
    isActive: true,
    isFeatured: true,
  ...
  },
  {
    ...
    images: ["https://pub-db4e48567ea54fc7b07ee1ddbc1f01eb.r2.dev/products/esponja-360.webp"],
    stock: 110,
    minQuantity: 1,
    isActive: true,
    isFeatured: true,
  ...
  },
  {
    ...
    slug: "kit-de-maquiagem-38-itens-com-acessorios-extras-para-revender",
    ...
    images: ["https://pub-db4e48567ea54fc7b07ee1ddbc1f01eb.r2.dev/products/kit-acessorios.webp"],
    stock: 35,
    minQuantity: 1,
    isActive: true,
    isFeatured: true,
  ...
  },
  {
    ...
    images: ["https://pub-db4e48567ea54fc7b07ee1ddbc1f01eb.r2.dev/products/kit-de-esponja-coxinha.webp"],
    stock: 140,
    minQuantity: 1,
    isActive: true,
    isFeatured: true,
